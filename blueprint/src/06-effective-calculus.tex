...
when such an integral is equal to an endpoint difference.  For the pi
scoreboard, this matters as a proof route: FTC can close the equivalence proof
for an existing integral computation of \(\pi\), even though it is not itself a
new pi algorithm.
...
object used by arctangent-integral pi equivalence targets.
\end{theorem}
