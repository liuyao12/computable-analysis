...
bisections divide the width by \(2^k\), and each bisection stays inside the
previous ordered interval.  These are the small interval-shrinking facts needed
later for square-root path lengths such as the circumference computation.
\end{remark}
