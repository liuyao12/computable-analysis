...
\]
This remains open, including $\zeta(2)=\pi^2/6$: the Basel module supplies
valid algorithms for both sides and certificate interfaces for their missing
comparison, not the comparison proof itself.

The reference evaluator is not optimized for speed near $s=1$. Its identification
with $E(-sL(n))$, parameter derivatives, Euler products, and continuation remain
