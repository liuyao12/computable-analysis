...
On an oriented side from $a$ to $b$, integrate the real and imaginary
components of $F(a+t(b-a))(b-a)$ on $[0,1]$. Supply finite monotonicity
partitions and rational range bounds for these two real functions.
