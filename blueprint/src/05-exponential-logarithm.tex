...
\section{Complex exponential and geometric trigonometry}
Define, by the factorial series, $E(z)$ for rational complex
inputs.  Coefficient separation gives its real and imaginary series.
The comparison with the original geometric functions is
\[
 E(i\pi x)=C(x)+iS(x).
\]
...
\input{05-logarithm-continuation.tex}
