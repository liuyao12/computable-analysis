...
\path[fill=underfill,fill opacity=.5,draw=under,draw opacity=.8,line width=.4pt] (57,136) rectangle (178.5,136);
\path[fill=underfill,fill opacity=.5,draw=under,draw opacity=.8,line width=.4pt] (57,39) rectangle (117.75,84);
...
\path[fill=underfill,fill opacity=.5,draw=under,draw opacity=.8,line width=.4pt] (178.5,136) rectangle (300,181);
\path[fill=underfill,fill opacity=.5,draw=under,draw opacity=.8,line width=.4pt] (117.75,39) rectangle (300,84);
