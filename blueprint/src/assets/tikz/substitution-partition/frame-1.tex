...
\path[fill=underfill,draw=under,draw opacity=.8,line width=.4pt] (57,136) rectangle (300,136);
\path[fill=underfill,draw=under,draw opacity=.8,line width=.4pt] (57,39) rectangle (300,84);
