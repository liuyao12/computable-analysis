...
\draw[grid,line width=.3pt] (115,34) -- (115,202);
\draw[axis,line width=.55pt] (115,31) -- (115,37);
\draw[grid,line width=.3pt] (136,34) -- (136,202);
\draw[axis,line width=.55pt] (136,31) -- (136,37);
\draw[grid,line width=.3pt] (157,34) -- (157,202);
\draw[axis,line width=.55pt] (157,31) -- (157,37);
\draw[grid,line width=.3pt] (178,34) -- (178,202);
\draw[axis,line width=.55pt] (178,31) -- (178,37);
\draw[grid,line width=.3pt] (199,34) -- (199,202);
\draw[axis,line width=.55pt] (199,31) -- (199,37);
\draw[grid,line width=.3pt] (220,34) -- (220,202);
\draw[axis,line width=.55pt] (220,31) -- (220,37);
\draw[grid,line width=.3pt] (241,34) -- (241,202);
\draw[axis,line width=.55pt] (241,31) -- (241,37);
\draw[grid,line width=.3pt] (262,34) -- (262,202);
\draw[axis,line width=.55pt] (262,31) -- (262,37);
\path[fill=sharedfill,fill opacity=.85] (94,34) rectangle (115,199.4154);
\path[fill=overfill,fill opacity=.5] (94,199.4154) rectangle (115,202);
\draw[under,draw opacity=.8,line width=0.45pt] (94,34) rectangle (115,199.4154);
\draw[over,draw opacity=.8,line width=0.45pt] (94,34) rectangle (115,202);
\path[fill=sharedfill,fill opacity=.85] (115,34) rectangle (136,192.1176);
\path[fill=overfill,fill opacity=.5] (115,192.1176) rectangle (136,199.4154);
\draw[under,draw opacity=.8,line width=0.45pt] (115,34) rectangle (136,192.1176);
\draw[over,draw opacity=.8,line width=0.45pt] (115,34) rectangle (136,199.4154);
\path[fill=sharedfill,fill opacity=.85] (136,34) rectangle (157,181.2877);
\path[fill=overfill,fill opacity=.5] (136,181.2877) rectangle (157,192.1176);
\draw[under,draw opacity=.8,line width=0.45pt] (136,34) rectangle (157,181.2877);
\draw[over,draw opacity=.8,line width=0.45pt] (136,34) rectangle (157,192.1176);
\path[fill=sharedfill,fill opacity=.85] (157,34) rectangle (178,168.4);
\path[fill=overfill,fill opacity=.5] (157,168.4) rectangle (178,181.2877);
\draw[under,draw opacity=.8,line width=0.45pt] (157,34) rectangle (178,168.4);
\draw[over,draw opacity=.8,line width=0.45pt] (157,34) rectangle (178,181.2877);
\path[fill=sharedfill,fill opacity=.85] (178,34) rectangle (199,154.809);
\path[fill=overfill,fill opacity=.5] (178,154.809) rectangle (199,168.4);
\draw[under,draw opacity=.8,line width=0.45pt] (178,34) rectangle (199,154.809);
\draw[over,draw opacity=.8,line width=0.45pt] (178,34) rectangle (199,168.4);
\path[fill=sharedfill,fill opacity=.85] (199,34) rectangle (220,141.52);
\path[fill=overfill,fill opacity=.5] (199,141.52) rectangle (220,154.809);
\draw[under,draw opacity=.8,line width=0.45pt] (199,34) rectangle (220,141.52);
\draw[over,draw opacity=.8,line width=0.45pt] (199,34) rectangle (220,154.809);
\path[fill=sharedfill,fill opacity=.85] (220,34) rectangle (241,129.1504);
\path[fill=overfill,fill opacity=.5] (220,129.1504) rectangle (241,141.52);
\draw[under,draw opacity=.8,line width=0.45pt] (220,34) rectangle (241,129.1504);
\draw[over,draw opacity=.8,line width=0.45pt] (220,34) rectangle (241,141.52);
\path[fill=sharedfill,fill opacity=.85] (241,34) rectangle (262,118);
\path[fill=overfill,fill opacity=.5] (241,118) rectangle (262,129.1504);
\draw[under,draw opacity=.8,line width=0.45pt] (241,34) rectangle (262,118);
\draw[over,draw opacity=.8,line width=0.45pt] (241,34) rectangle (262,129.1504);
