...
\path[fill=sharedfill] (94,34) rectangle (115,199.4154);
\path[fill=overfill] (94,199.4154) rectangle (115,202);
...
\path[fill=sharedfill] (115,34) rectangle (136,192.1176);
\path[fill=overfill] (115,192.1176) rectangle (136,199.4154);
...
\path[fill=sharedfill] (136,34) rectangle (157,181.2877);
\path[fill=overfill] (136,181.2877) rectangle (157,192.1176);
...
\path[fill=sharedfill] (157,34) rectangle (178,168.4);
\path[fill=overfill] (157,168.4) rectangle (178,181.2877);
...
\path[fill=sharedfill] (178,34) rectangle (199,154.809);
\path[fill=overfill] (178,154.809) rectangle (199,168.4);
...
\path[fill=sharedfill] (199,34) rectangle (220,141.52);
\path[fill=overfill] (199,141.52) rectangle (220,154.809);
...
\path[fill=sharedfill] (220,34) rectangle (241,129.1504);
\path[fill=overfill] (220,129.1504) rectangle (241,141.52);
...
\path[fill=sharedfill] (241,34) rectangle (262,118);
\path[fill=overfill] (241,118) rectangle (262,129.1504);
