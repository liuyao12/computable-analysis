...
\path[fill=sharedfill,fill opacity=.85] (94,34) rectangle (178,168.4);
\path[fill=overfill,fill opacity=.5] (94,168.4) rectangle (178,202);
\draw[under,draw opacity=.8,line width=0.45pt] (94,34) rectangle (178,168.4);
\draw[over,draw opacity=.8,line width=0.45pt] (94,34) rectangle (178,202);
\path[fill=sharedfill,fill opacity=.85] (178,34) rectangle (262,118);
\path[fill=overfill,fill opacity=.5] (178,118) rectangle (262,168.4);
\draw[under,draw opacity=.8,line width=0.45pt] (178,34) rectangle (262,118);
\draw[over,draw opacity=.8,line width=0.45pt] (178,34) rectangle (262,168.4);
