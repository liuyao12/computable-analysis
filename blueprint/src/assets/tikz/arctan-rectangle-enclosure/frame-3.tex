...
\path[fill=orangefill,draw=orange,line width=.45pt] (94,34) rectangle (136,202);
\path[fill=tealfill,draw=teal,line width=.45pt] (94,34) rectangle (136,192.1176);
\path[fill=orangefill,draw=orange,line width=.45pt] (136,34) rectangle (178,192.1176);
\path[fill=tealfill,draw=teal,line width=.45pt] (136,34) rectangle (178,168.4);
\path[fill=orangefill,draw=orange,line width=.45pt] (178,34) rectangle (220,168.4);
\path[fill=tealfill,draw=teal,line width=.45pt] (178,34) rectangle (220,141.52);
\path[fill=orangefill,draw=orange,line width=.45pt] (220,34) rectangle (262,141.52);
\path[fill=tealfill,draw=teal,line width=.45pt] (220,34) rectangle (262,118);
