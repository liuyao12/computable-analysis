...
\path[fill=sharedfill] (94,34) rectangle (136,192.1176);
\path[fill=overfill] (94,192.1176) rectangle (136,202);
...
\path[fill=sharedfill] (136,34) rectangle (178,168.4);
\path[fill=overfill] (136,168.4) rectangle (178,192.1176);
...
\path[fill=sharedfill] (178,34) rectangle (220,141.52);
\path[fill=overfill] (178,141.52) rectangle (220,168.4);
...
\path[fill=sharedfill] (220,34) rectangle (262,118);
\path[fill=overfill] (220,118) rectangle (262,141.52);
