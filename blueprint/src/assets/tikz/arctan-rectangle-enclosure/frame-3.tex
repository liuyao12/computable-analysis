...
\path[fill=sharedfill,fill opacity=.85] (94,34) rectangle (136,192.1176);
\path[fill=overfill,fill opacity=.5] (94,192.1176) rectangle (136,202);
\draw[under,draw opacity=.8,line width=0.45pt] (94,34) rectangle (136,192.1176);
\draw[over,draw opacity=.8,line width=0.45pt] (94,34) rectangle (136,202);
\path[fill=sharedfill,fill opacity=.85] (136,34) rectangle (178,168.4);
\path[fill=overfill,fill opacity=.5] (136,168.4) rectangle (178,192.1176);
\draw[under,draw opacity=.8,line width=0.45pt] (136,34) rectangle (178,168.4);
\draw[over,draw opacity=.8,line width=0.45pt] (136,34) rectangle (178,192.1176);
\path[fill=sharedfill,fill opacity=.85] (178,34) rectangle (220,141.52);
\path[fill=overfill,fill opacity=.5] (178,141.52) rectangle (220,168.4);
\draw[under,draw opacity=.8,line width=0.45pt] (178,34) rectangle (220,141.52);
\draw[over,draw opacity=.8,line width=0.45pt] (178,34) rectangle (220,168.4);
\path[fill=sharedfill,fill opacity=.85] (220,34) rectangle (262,118);
\path[fill=overfill,fill opacity=.5] (220,118) rectangle (262,141.52);
\draw[under,draw opacity=.8,line width=0.45pt] (220,34) rectangle (262,118);
\draw[over,draw opacity=.8,line width=0.45pt] (220,34) rectangle (262,141.52);
