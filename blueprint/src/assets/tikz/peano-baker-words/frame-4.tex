...
\path[fill=purple] (125,86) rectangle (158,104);
\node[font=\small,text=white] at (141.5,95) {$B_2$};
\path[fill=purple] (125,60) rectangle (158,78);
\node[font=\small,text=white] at (141.5,69) {$B_2$};
\path[fill=teal] (163,60) rectangle (196,78);
\node[font=\small,text=white] at (179.5,69) {$B_0$};
\path[fill=purple] (125,34) rectangle (158,52);
\node[font=\small,text=white] at (141.5,43) {$B_2$};
\path[fill=orange] (163,34) rectangle (196,52);
\node[font=\small,text=white] at (179.5,43) {$B_1$};
\path[fill=purple] (125,8) rectangle (158,26);
\node[font=\small,text=white] at (141.5,17) {$B_2$};
\path[fill=orange] (163,8) rectangle (196,26);
\node[font=\small,text=white] at (179.5,17) {$B_1$};
\path[fill=teal] (201,8) rectangle (234,26);
\node[font=\small,text=white] at (217.5,17) {$B_0$};
