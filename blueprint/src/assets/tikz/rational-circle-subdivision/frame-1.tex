...
\path[fill=overfill,fill opacity=.5,draw=over,draw opacity=.8,line width=.45pt] (166,62) -- (272,62) -- (272,168) -- (166,168) -- cycle;
\path[fill=underfill,fill opacity=.5,draw=under,draw opacity=.8,line width=.45pt] (166,62) -- (272,62) -- (166,168) -- cycle;
