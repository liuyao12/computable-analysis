...
\path[fill=overfill,fill opacity=.5,draw=over,draw opacity=.8,line width=.45pt] (166,62) -- (272,62) -- (272,88.5) -- (248.4444,132.6667) -- (214.1818,158.3636) -- (181.1429,168) -- (166,168) -- cycle;
\path[fill=underfill,fill opacity=.5,draw=under,draw opacity=.8,line width=.45pt] (166,62) -- (272,62) -- (259.5294,111.8824) -- (229.6,146.8) -- (195.68,163.76) -- (166,168) -- cycle;
