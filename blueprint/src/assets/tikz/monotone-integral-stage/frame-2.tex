...
\path[fill=orangefill,draw=orange,line width=.45pt] (94,34) rectangle (178,202);
\path[fill=tealfill,draw=teal,line width=.45pt] (94,34) rectangle (178,168.4);
\path[fill=orangefill,draw=orange,line width=.45pt] (178,34) rectangle (262,168.4);
\path[fill=tealfill,draw=teal,line width=.45pt] (178,34) rectangle (262,118);
