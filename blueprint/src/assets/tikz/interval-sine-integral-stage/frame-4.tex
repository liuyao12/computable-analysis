...
\draw[grid,line width=.3pt] (87,35) -- (87,190);
\draw[axis,line width=.55pt] (87,32) -- (87,38);
\draw[grid,line width=.3pt] (122,35) -- (122,190);
\draw[axis,line width=.55pt] (122,32) -- (122,38);
\draw[grid,line width=.3pt] (157,35) -- (157,190);
\draw[axis,line width=.55pt] (157,32) -- (157,38);
\draw[grid,line width=.3pt] (192,35) -- (192,190);
\draw[axis,line width=.55pt] (192,32) -- (192,38);
\draw[grid,line width=.3pt] (227,35) -- (227,190);
\draw[axis,line width=.55pt] (227,32) -- (227,38);
\draw[grid,line width=.3pt] (262,35) -- (262,190);
\draw[axis,line width=.55pt] (262,32) -- (262,38);
\draw[grid,line width=.3pt] (297,35) -- (297,190);
\draw[axis,line width=.55pt] (297,32) -- (297,38);
\draw[grid,line width=.3pt] (332,35) -- (332,190);
\draw[axis,line width=.55pt] (332,32) -- (332,38);
\path[fill=sharedfill] (52,35) rectangle (87,35);
\path[fill=overfill] (52,35) rectangle (87,60.5935);
\draw[under,draw opacity=.8,line width=0.45pt] (52,35) rectangle (87,35);
\draw[over,draw opacity=.8,line width=0.45pt] (52,35) rectangle (87,60.5935);
\path[fill=sharedfill] (87,35) rectangle (122,56.5065);
\path[fill=overfill] (87,56.5065) rectangle (122,83.8237);
\draw[under,draw opacity=.8,line width=0.45pt] (87,35) rectangle (122,56.5065);
\draw[over,draw opacity=.8,line width=0.45pt] (87,35) rectangle (122,83.8237);
\path[fill=sharedfill] (122,35) rectangle (157,79.2826);
\path[fill=overfill] (122,79.2826) rectangle (157,105.973);
\draw[under,draw opacity=.8,line width=0.45pt] (122,35) rectangle (157,79.2826);
\draw[over,draw opacity=.8,line width=0.45pt] (122,35) rectangle (157,105.973);
\path[fill=sharedfill] (157,35) rectangle (192,100.9778);
\path[fill=overfill] (157,100.9778) rectangle (192,126.5324);
\draw[under,draw opacity=.8,line width=0.45pt] (157,35) rectangle (192,100.9778);
\draw[over,draw opacity=.8,line width=0.45pt] (157,35) rectangle (192,126.5324);
\path[fill=sharedfill] (192,35) rectangle (227,121.0831);
\path[fill=overfill] (192,121.0831) rectangle (227,145.0297);
\draw[under,draw opacity=.8,line width=0.45pt] (192,35) rectangle (227,121.0831);
\draw[over,draw opacity=.8,line width=0.45pt] (192,35) rectangle (227,145.0297);
\path[fill=sharedfill] (227,35) rectangle (262,139.1263);
\path[fill=overfill] (227,139.1263) rectangle (262,161.0408);
\draw[under,draw opacity=.8,line width=0.45pt] (227,35) rectangle (262,139.1263);
\draw[over,draw opacity=.8,line width=0.45pt] (227,35) rectangle (262,161.0408);
\path[fill=sharedfill] (262,35) rectangle (297,154.6832);
\path[fill=overfill] (262,154.6832) rectangle (297,174.1991);
\draw[under,draw opacity=.8,line width=0.45pt] (262,35) rectangle (297,154.6832);
\draw[over,draw opacity=.8,line width=0.45pt] (262,35) rectangle (297,174.1991);
\path[fill=sharedfill] (297,35) rectangle (332,167.3874);
\path[fill=overfill] (297,167.3874) rectangle (332,190);
\draw[under,draw opacity=.8,line width=0.45pt] (297,35) rectangle (332,167.3874);
\draw[over,draw opacity=.8,line width=0.45pt] (297,35) rectangle (332,190);
...
\draw[curve,line width=.8pt] (87,56.5065) -- (87,60.5935);
\draw[curve,line width=.6pt] (84.5,56.5065) -- (89.5,56.5065);
\draw[curve,line width=.6pt] (84.5,60.5935) -- (89.5,60.5935);
\draw[curve,line width=.8pt] (122,79.2826) -- (122,83.8237);
\draw[curve,line width=.6pt] (119.5,79.2826) -- (124.5,79.2826);
\draw[curve,line width=.6pt] (119.5,83.8237) -- (124.5,83.8237);
\draw[curve,line width=.8pt] (157,100.9778) -- (157,105.973);
\draw[curve,line width=.6pt] (154.5,100.9778) -- (159.5,100.9778);
\draw[curve,line width=.6pt] (154.5,105.973) -- (159.5,105.973);
\draw[curve,line width=.8pt] (192,121.0831) -- (192,126.5324);
\draw[curve,line width=.6pt] (189.5,121.0831) -- (194.5,121.0831);
\draw[curve,line width=.6pt] (189.5,126.5324) -- (194.5,126.5324);
\draw[curve,line width=.8pt] (227,139.1263) -- (227,145.0297);
\draw[curve,line width=.6pt] (224.5,139.1263) -- (229.5,139.1263);
\draw[curve,line width=.6pt] (224.5,145.0297) -- (229.5,145.0297);
\draw[curve,line width=.8pt] (262,154.6832) -- (262,161.0408);
\draw[curve,line width=.6pt] (259.5,154.6832) -- (264.5,154.6832);
\draw[curve,line width=.6pt] (259.5,161.0408) -- (264.5,161.0408);
\draw[curve,line width=.8pt] (297,167.3874) -- (297,174.1991);
\draw[curve,line width=.6pt] (294.5,167.3874) -- (299.5,167.3874);
\draw[curve,line width=.6pt] (294.5,174.1991) -- (299.5,174.1991);
