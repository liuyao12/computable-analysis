...
\path[fill=sharedfill] (52,35) rectangle (192,35);
\path[fill=overfill] (52,35) rectangle (192,134.5895);
\draw[under,draw opacity=.8,line width=0.45pt] (52,35) rectangle (192,35);
\draw[over,draw opacity=.8,line width=0.45pt] (52,35) rectangle (192,134.5895);
\path[fill=sharedfill] (192,35) rectangle (332,112.7925);
\path[fill=overfill] (192,112.7925) rectangle (332,190);
\draw[under,draw opacity=.8,line width=0.45pt] (192,35) rectangle (332,112.7925);
\draw[over,draw opacity=.8,line width=0.45pt] (192,35) rectangle (332,190);
...
\draw[curve,line width=.8pt] (192,112.7925) -- (192,134.5895);
\draw[curve,line width=.6pt] (189.5,112.7925) -- (194.5,112.7925);
\draw[curve,line width=.6pt] (189.5,134.5895) -- (194.5,134.5895);
