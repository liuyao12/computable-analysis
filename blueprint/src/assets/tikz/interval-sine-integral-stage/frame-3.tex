...
\path[fill=sharedfill] (52,35) rectangle (122,35);
\path[fill=overfill] (52,35) rectangle (122,86.0806);
\draw[under,draw opacity=.8,line width=0.45pt] (52,35) rectangle (122,35);
\draw[over,draw opacity=.8,line width=0.45pt] (52,35) rectangle (122,86.0806);
\path[fill=sharedfill] (122,35) rectangle (192,76.9985);
\path[fill=overfill] (122,76.9985) rectangle (192,129.2336);
\draw[under,draw opacity=.8,line width=0.45pt] (122,35) rectangle (192,76.9985);
\draw[over,draw opacity=.8,line width=0.45pt] (122,35) rectangle (192,129.2336);
\path[fill=sharedfill] (192,35) rectangle (262,118.3351);
\path[fill=overfill] (192,118.3351) rectangle (262,164.1934);
\draw[under,draw opacity=.8,line width=0.45pt] (192,35) rectangle (262,118.3351);
\draw[over,draw opacity=.8,line width=0.45pt] (192,35) rectangle (262,164.1934);
\path[fill=sharedfill] (262,35) rectangle (332,151.4785);
\path[fill=overfill] (262,151.4785) rectangle (332,190);
\draw[under,draw opacity=.8,line width=0.45pt] (262,35) rectangle (332,151.4785);
\draw[over,draw opacity=.8,line width=0.45pt] (262,35) rectangle (332,190);
...
\draw[curve,line width=.8pt] (122,76.9985) -- (122,86.0806);
\draw[curve,line width=.6pt] (119.5,76.9985) -- (124.5,76.9985);
\draw[curve,line width=.6pt] (119.5,86.0806) -- (124.5,86.0806);
\draw[curve,line width=.8pt] (192,118.3351) -- (192,129.2336);
\draw[curve,line width=.6pt] (189.5,118.3351) -- (194.5,118.3351);
\draw[curve,line width=.6pt] (189.5,129.2336) -- (194.5,129.2336);
\draw[curve,line width=.8pt] (262,151.4785) -- (262,164.1934);
\draw[curve,line width=.6pt] (259.5,151.4785) -- (264.5,151.4785);
\draw[curve,line width=.6pt] (259.5,164.1934) -- (264.5,164.1934);
