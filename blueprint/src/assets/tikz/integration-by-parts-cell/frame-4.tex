...
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (77,67) rectangle (100.75,67);
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (77,67) rectangle (77,69.9688);
\path[fill=gapfill,draw=gap,draw opacity=.8,line width=.4pt] (77,67) rectangle (100.75,69.9688);
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (100.75,67) rectangle (124.5,69.9688);
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (77,69.9688) rectangle (100.75,78.875);
\path[fill=gapfill,draw=gap,draw opacity=.8,line width=.4pt] (100.75,69.9688) rectangle (124.5,78.875);
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (124.5,67) rectangle (148.25,78.875);
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (77,78.875) rectangle (124.5,93.7188);
\path[fill=gapfill,draw=gap,draw opacity=.8,line width=.4pt] (124.5,78.875) rectangle (148.25,93.7188);
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (148.25,67) rectangle (172,93.7188);
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (77,93.7188) rectangle (148.25,114.5);
\path[fill=gapfill,draw=gap,draw opacity=.8,line width=.4pt] (148.25,93.7188) rectangle (172,114.5);
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (172,67) rectangle (195.75,114.5);
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (77,114.5) rectangle (172,141.2188);
\path[fill=gapfill,draw=gap,draw opacity=.8,line width=.4pt] (172,114.5) rectangle (195.75,141.2188);
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (195.75,67) rectangle (219.5,141.2188);
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (77,141.2188) rectangle (195.75,173.875);
\path[fill=gapfill,draw=gap,draw opacity=.8,line width=.4pt] (195.75,141.2188) rectangle (219.5,173.875);
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (219.5,67) rectangle (243.25,173.875);
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (77,173.875) rectangle (219.5,212.4688);
\path[fill=gapfill,draw=gap,draw opacity=.8,line width=.4pt] (219.5,173.875) rectangle (243.25,212.4688);
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (243.25,67) rectangle (267,212.4688);
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (77,212.4688) rectangle (243.25,257);
