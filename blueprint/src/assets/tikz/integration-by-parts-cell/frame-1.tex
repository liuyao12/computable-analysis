...
\path[fill=underfill,fill opacity=.5,draw=under,draw opacity=.8,line width=.3pt] (77,67) rectangle (267,67);
\path[fill=underfill,fill opacity=.5,draw=under,draw opacity=.8,line width=.3pt] (77,67) rectangle (77,257);
