...
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (77,67) rectangle (267,67);
\path[fill=sharedfill,draw=shared,draw opacity=.8,line width=.3pt] (77,67) rectangle (77,257);
