...
\path[fill=underfill,fill opacity=.5,draw=under,draw opacity=.8,line width=.3pt] (77,67) rectangle (172,67);
\path[fill=underfill,fill opacity=.5,draw=under,draw opacity=.8,line width=.3pt] (77,67) rectangle (77,114.5);
\path[fill=gapfill,draw=gap,draw opacity=.8,line width=.4pt] (77,67) rectangle (172,114.5);
\path[fill=underfill,fill opacity=.5,draw=under,draw opacity=.8,line width=.3pt] (172,67) rectangle (267,114.5);
\path[fill=underfill,fill opacity=.5,draw=under,draw opacity=.8,line width=.3pt] (77,114.5) rectangle (172,257);
