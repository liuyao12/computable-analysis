...
\path[fill=sharedfill,fill opacity=.85,draw=shared,draw opacity=.8,line width=.3pt] (77,67) rectangle (172,67);
\path[fill=sharedfill,fill opacity=.85,draw=shared,draw opacity=.8,line width=.3pt] (77,67) rectangle (77,114.5);
\path[fill=gapfill,draw=gap,draw opacity=.8,line width=.4pt] (77,67) rectangle (172,114.5);
\path[fill=sharedfill,fill opacity=.85,draw=shared,draw opacity=.8,line width=.3pt] (172,67) rectangle (267,114.5);
\path[fill=sharedfill,fill opacity=.85,draw=shared,draw opacity=.8,line width=.3pt] (77,114.5) rectangle (172,257);
\path[fill=gapfill,draw=gap,draw opacity=.8,line width=.4pt] (172,114.5) rectangle (267,257);
\draw[ink,line width=.8pt] plot coordinates {(77,67) (172,67) (172,114.5) (267,114.5) (267,257)};
\draw[ink,line width=.8pt] plot coordinates {(77,67) (77,114.5) (172,114.5) (172,257) (267,257)};
