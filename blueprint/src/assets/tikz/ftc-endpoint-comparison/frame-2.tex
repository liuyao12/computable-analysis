...
\path[fill=orangefill,draw=orange,line width=.4pt] (246,45) rectangle (296,145);
\path[fill=tealfill,draw=teal,line width=.4pt] (246,45) rectangle (296,45);
\path[fill=orangefill,draw=orange,line width=.4pt] (296,45) rectangle (346,245);
\path[fill=tealfill,draw=teal,line width=.4pt] (296,45) rectangle (346,145);
