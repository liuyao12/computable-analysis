...
\path[fill=overfill,fill opacity=.5,draw=over,draw opacity=.8,line width=.4pt] (246,45) rectangle (296,145);
\path[fill=underfill,fill opacity=.5,draw=under,draw opacity=.8,line width=.4pt] (246,45) rectangle (296,45);
\path[fill=overfill,fill opacity=.5,draw=over,draw opacity=.8,line width=.4pt] (296,45) rectangle (346,245);
\path[fill=underfill,fill opacity=.5,draw=under,draw opacity=.8,line width=.4pt] (296,45) rectangle (346,145);
