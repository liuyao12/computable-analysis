...
\path[fill=sharedfill,fill opacity=.85] (246,45) rectangle (271,45);
\path[fill=overfill,fill opacity=.5] (246,45) rectangle (271,95);
...
\path[fill=sharedfill,fill opacity=.85] (271,45) rectangle (296,95);
\path[fill=overfill,fill opacity=.5] (271,95) rectangle (296,145);
...
\path[fill=sharedfill,fill opacity=.85] (296,45) rectangle (321,145);
\path[fill=overfill,fill opacity=.5] (296,145) rectangle (321,195);
...
\path[fill=sharedfill,fill opacity=.85] (321,45) rectangle (346,195);
\path[fill=overfill,fill opacity=.5] (321,195) rectangle (346,245);
