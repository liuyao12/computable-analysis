...
\path[fill=sharedfill] (246,45) rectangle (271,45);
\path[fill=overfill] (246,45) rectangle (271,95);
\draw[under,draw opacity=.8,line width=0.4pt] (246,45) rectangle (271,45);
\draw[over,draw opacity=.8,line width=0.4pt] (246,45) rectangle (271,95);
\path[fill=sharedfill] (271,45) rectangle (296,95);
\path[fill=overfill] (271,95) rectangle (296,145);
\draw[under,draw opacity=.8,line width=0.4pt] (271,45) rectangle (296,95);
\draw[over,draw opacity=.8,line width=0.4pt] (271,45) rectangle (296,145);
\path[fill=sharedfill] (296,45) rectangle (321,145);
\path[fill=overfill] (296,145) rectangle (321,195);
\draw[under,draw opacity=.8,line width=0.4pt] (296,45) rectangle (321,145);
\draw[over,draw opacity=.8,line width=0.4pt] (296,45) rectangle (321,195);
\path[fill=sharedfill] (321,45) rectangle (346,195);
\path[fill=overfill] (321,195) rectangle (346,245);
\draw[under,draw opacity=.8,line width=0.4pt] (321,45) rectangle (346,195);
\draw[over,draw opacity=.8,line width=0.4pt] (321,45) rectangle (346,245);
