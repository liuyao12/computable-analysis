...
\path[fill=orangefill,draw=orange,line width=.4pt] (246,45) rectangle (271,95);
\path[fill=tealfill,draw=teal,line width=.4pt] (246,45) rectangle (271,45);
\path[fill=orangefill,draw=orange,line width=.4pt] (271,45) rectangle (296,145);
\path[fill=tealfill,draw=teal,line width=.4pt] (271,45) rectangle (296,95);
\path[fill=orangefill,draw=orange,line width=.4pt] (296,45) rectangle (321,195);
\path[fill=tealfill,draw=teal,line width=.4pt] (296,45) rectangle (321,145);
\path[fill=orangefill,draw=orange,line width=.4pt] (321,45) rectangle (346,245);
\path[fill=tealfill,draw=teal,line width=.4pt] (321,45) rectangle (346,195);
