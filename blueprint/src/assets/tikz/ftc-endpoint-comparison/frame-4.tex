...
\path[fill=orangefill,draw=orange,line width=.4pt] (246,45) rectangle (258.5,70);
\path[fill=tealfill,draw=teal,line width=.4pt] (246,45) rectangle (258.5,45);
\path[fill=orangefill,draw=orange,line width=.4pt] (258.5,45) rectangle (271,95);
\path[fill=tealfill,draw=teal,line width=.4pt] (258.5,45) rectangle (271,70);
\path[fill=orangefill,draw=orange,line width=.4pt] (271,45) rectangle (283.5,120);
\path[fill=tealfill,draw=teal,line width=.4pt] (271,45) rectangle (283.5,95);
\path[fill=orangefill,draw=orange,line width=.4pt] (283.5,45) rectangle (296,145);
\path[fill=tealfill,draw=teal,line width=.4pt] (283.5,45) rectangle (296,120);
\path[fill=orangefill,draw=orange,line width=.4pt] (296,45) rectangle (308.5,170);
\path[fill=tealfill,draw=teal,line width=.4pt] (296,45) rectangle (308.5,145);
\path[fill=orangefill,draw=orange,line width=.4pt] (308.5,45) rectangle (321,195);
\path[fill=tealfill,draw=teal,line width=.4pt] (308.5,45) rectangle (321,170);
\path[fill=orangefill,draw=orange,line width=.4pt] (321,45) rectangle (333.5,220);
\path[fill=tealfill,draw=teal,line width=.4pt] (321,45) rectangle (333.5,195);
\path[fill=orangefill,draw=orange,line width=.4pt] (333.5,45) rectangle (346,245);
\path[fill=tealfill,draw=teal,line width=.4pt] (333.5,45) rectangle (346,220);
