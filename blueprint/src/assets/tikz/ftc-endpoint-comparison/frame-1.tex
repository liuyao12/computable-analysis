...
\path[fill=sharedfill] (246,45) rectangle (346,45);
\path[fill=overfill] (246,45) rectangle (346,245);
\draw[under,draw opacity=.8,line width=0.4pt] (246,45) rectangle (346,45);
\draw[over,draw opacity=.8,line width=0.4pt] (246,45) rectangle (346,245);
