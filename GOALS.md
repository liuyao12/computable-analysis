...
| T | `4u/(1+u^2)^2` on `[0,1]` | `2u^2/(1+u^2)` | `1` | complete `CandidateDerivativeFTC` certificate in `TangentPullbackEffectiveFTC.lean`; equivalence exported by `tangentPullbackEffectiveFTC_equiv_endpoint` |
