...
| T | `4u/(1+u^2)^2` on `[0,1]` | `2u^2/(1+u^2)` | `1` | finite rational secant, Lipschitz, and dyadic endpoint-equivalence proofs complete; generic derivative-bound packaging is the next adapter |
