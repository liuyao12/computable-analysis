...
| `4 * arctanIntegralRectangleForAtOne` | [finite rectangle comparison](https://liuyao12.github.io/computable-analysis/ch-integrals.html#thm:finite-arctan-integral-comparison), [integral pi target](https://liuyao12.github.io/computable-analysis/ch-integrals.html#thm:arctan-integral-pi) | \(\pi=4\int_0^1 \frac{dt}{1+t^2}\), via midpoint rectangle sums. | ✓ | ✓ |
| `4 * arctanIntegralFareyFor(1)` | [finite Farey-prefix comparison](https://liuyao12.github.io/computable-analysis/ch-integrals.html#thm:finite-arctan-integral-comparison), [integral pi target](https://liuyao12.github.io/computable-analysis/ch-integrals.html#thm:arctan-integral-pi) | \(\pi=4I(0,1)\), where \(I\) uses the global Farey-prefix mesh. | ✓ | ✗ |
...
| `Brouncker(4/pi)` | [Ch. 1: sources of raw reals](https://liuyao12.github.io/computable-analysis/sect0002.html#rem:sources-of-raw-reals) | Brouncker continued fraction for \(4/\pi\). | ✗ | ✗ |
| **Logarithm-at-i routes** | [route overview](https://liuyao12.github.io/computable-analysis/ch-exponential-logarithm.html#thm:log-at-i-pi-routes), [series continuation](https://liuyao12.github.io/computable-analysis/ch-exponential-logarithm.html#def:complex-log-series-at-i), [path integral](https://liuyao12.github.io/computable-analysis/ch-exponential-logarithm.html#def:complex-log-path-integral-at-i), [inverse exp](https://liuyao12.github.io/computable-analysis/ch-exponential-logarithm.html#def:complex-log-inv-exp-at-i), [Euler identity](https://liuyao12.github.io/computable-analysis/ch-exponential-logarithm.html#thm:euler-identity) | \(\pi=-2i\log(i)\), with different constructions of \(\log(i)\). |  |  |
