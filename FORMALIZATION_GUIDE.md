...
| Discrete linear ODE / Peano--Baker core | `ComputableAnalysis.PeanoBaker` | `LinearODE.DiscreteLinearSystem`, `chronologicalProduct`, `peanoBakerDiscreteSum`, and the exact square-zero transition `constantPeanoBakerSimplexPartial_add_two_eq_identity_add_scale_of_mul_self_eq_zero` |
