...
The arcsine/Newton and Gaussian rows remain future probes for inverse/
square-root integration and the exponential/full-line layers; advanced routes
are intentionally omitted from this progress table.
