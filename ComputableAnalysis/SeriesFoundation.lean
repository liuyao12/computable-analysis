...
This scoped entry point collects the rational coefficient, finite-prefix, and
Fourier-tail interfaces.  It exposes computable series certificates without
importing optional subject modules or introducing a completed function space.
-/
